 ...
 * generated in the JAXWS.topdown package. 
...
public class ObjectFactory {
    ...
    private final static QName _IssueTicket_QNAME = new QName("http://topdown.se/", "issueTicket");
    private final static QName _BookTicket_QNAME = new QName("http://topdown.se/", "bookTicket");
    private final static QName _UnauthorizedException_QNAME = new QName("http://topdown.se/", "UnauthorizedException");
    private final static QName _BookTicketResponse_QNAME = new QName("http://topdown.se/", "bookTicketResponse");
    private final static QName _IssueTicketResponse_QNAME = new QName("http://topdown.se/", "issueTicketResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: JAXWS.topdown
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.se/", name = "issueTicket")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.se/", name = "bookTicket")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.se/", name = "UnauthorizedException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.se/", name = "bookTicketResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.se/", name = "issueTicketResponse")
