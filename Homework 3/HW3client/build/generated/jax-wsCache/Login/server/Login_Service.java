 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/PWS-HW3/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://Server/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/PWS-HW3/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://Server/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server/", "LoginPort"), Login.class, features);
    }
